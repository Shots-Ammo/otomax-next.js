...
const Contact = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // ════════════════════════════════════════════════════════════
        // TARGET: Main Contact Form
        // URL: https://n8n.srv1587679.hstgr.cloud/webhook/main-contact-form
        // ════════════════════════════════════════════════════════════
        try {
                            ...
                            <AnimatePresence mode="wait">
                                {!isSubmitted ? (
                                    ...
                                    >
                                        <div className="space-y-4">
                                            <div className="relative">
                                                <label className="text-sm font-semibold text-slate-700 mb-2 block">{t("form.fullName")}</label>
                                                <div className="relative">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                <div className="relative">
                                                    <label className="text-sm font-semibold text-slate-700 mb-2 block">{t("form.phone")}</label>
                                                ...
                                                <div className="relative">
                                                    <label className="text-sm font-semibold text-slate-700 mb-2 block">{t("form.email")}</label>
                                                    <div className="relative">
                                            ...
                                            <div className="relative">
                                                <label className="text-sm font-semibold text-slate-700 mb-2 block">{t("form.serviceType")}</label>
                                                <div className="relative">
                                            ...
                                            <div className="relative">
                                                <label className="text-sm font-semibold text-slate-700 mb-2 block">{t("form.message")}</label>
                                                <div className="relative">
                                    ...
                                    >
                                        ...
                                        <h3 className="text-3xl font-bold text-slate-900 mb-4">{t("success.title")}</h3>
                                        ...
                                        <motion.button
                                            ...
                                            onClick={() => {
                                                ...
                                                setFormData({ name: "", countryCode: "+966", phone: "", email: "", service: "", message: "", formName: "Contact Form" });
                                            }}
